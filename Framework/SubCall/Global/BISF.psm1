...
#>
    ...
    IF ($mainmodulename -ne $null) {
		...
		IF ($ExportSharedConfiguration) {$Host.UI.RawUI.WindowTitle = "$BISFtitle [2019 - $BISFversion] - ExportSharedConfiguration"} ELSE {$Host.UI.RawUI.WindowTitle = "$BISFtitle [2017 - $BISFversion]"}
