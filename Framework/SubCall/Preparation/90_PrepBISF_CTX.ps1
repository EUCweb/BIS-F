...
<#
	...
	.NOTES
		...
		01.07.2018 MS: Bugfix 44: Pickup the right Citrix Optimizer Default Template, like Citrix_Windows10_1803.xml, also prepare for Server 2019 Template, like Citrix_WindowsServer2019_1803.xml
